...
# Prompts,
# Send requests through API
# Get completions
class OpenAIAgent(BaseCodeAgent):
    def __init__(self, agent_name: str, tools: list[Tool] = [], loop_limit: int = 5, model: str = "gpt-4.1"):
        # Inherit init
    ...
    def __call__(self, question: str, debug: bool = False, eval_check: bool = False) -> str:
        ...
        for i in range(self.loop_limit):
            ...
            try:
                ...
                return f"OpenAI completion error: {e}"
